...
public class Diamond_Search {
	static final Logger logger = Logger.getLogger(Diamond_Search.class);
		...
		public void Filter_By_Diamond_TestCase(String price_left,String Carat_left,int Color_left_param,int Color_right_param,int Cut_left_param,int Cut_right_param,int Clarity_left_param,int Clarity_right_param,int flo_left_param,int flo_right_param) throws InterruptedException {
			...
			((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();", fbd.Photo_Video());
			...
			WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/div[2]/div/section/div[3]/div/div[4]/div[1]/div/div/div[1]/div[1]/div[2]/div[1]/span/span")));
			element.click();
			//Thread.sleep(2000);
			
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			System.out.println("Total Search Time taken: " + totalTime + "milliseconds");
